    ...
    <BaseLayout>
      ...
      <form>
        ...
        <div className="mt-6 flex items-center gap-8">
          <button type="submit" className="px-10 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600">
            Comprar
          </button>
