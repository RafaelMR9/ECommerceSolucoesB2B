      ...
      <ProtectedRoute isProtected>
        <BaseLayout>
          ...
          {user.is_superuser ?
            <>
              <div className="mb-12">
                <p className="text-2xl font-semibold text-slate-800 mb-2">Organizações Compradoras</p>
                <hr className="mb-6 border-2 border-slate-300"/>
                <div className="grid grid-cols-2 text-2xl text-center gap-64">
              ...
              <div>
                <p className="text-2xl font-semibold text-slate-800 mb-2">Fornecedores</p>
                <hr className="mb-6 border-2 border-slate-300"/>
                <div className="grid grid-cols-2 text-2xl text-center gap-64">
